...
export default {
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'description', content: '日本初のセパタクロー国内リーグ ES LEAGUE 公式サイトです。' || '' },
      { name: 'format-detection', content: 'telephone=no' },
      { name: 'keywords', content: 'セパタクロー,セパタクローリーグ,エスリーグ,エス リーグ,SEPAKTAKRAW,sepaktakraw,セパ,ES LEAGUE,日本初,ESLEAGUE' },

      { property: 'og:site_name', content: 'ES LEAGUE' },
      { property: 'og:type', content: 'website' },
      { property: 'og:url', content: 'https://es-league.jp' },
      { property: 'og:title', content: 'ES LEAGUE 公式サイト' },
      { property: 'og:description', content: '日本初のセパタクロー国内リーグ ES LEAGUE 公式サイトです' },
      { property: 'og:image', content: 'https://es-league.jp/img/ogp/ogp.png' },
